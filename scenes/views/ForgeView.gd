# ForgeView.gd
# The Boneyard Forge (P5): the Forge recipe grid — weapons from ores,
...
func _init() -> void:
	...
	view_subtitle = "Ores hammered into weapons, gems set into trinkets. Equip the results from a minion's page in the Necronomicon."
	verb = "Smith"
	accent = Color("#c08a4a")
